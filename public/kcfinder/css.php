...
div.file {
    overflow-x: hidden;
    width: 200<?php //echo $config['thumbWidth'] ?>px;
    float: left;
    text-align: center;
    cursor: default;
    white-space: nowrap;
...
div.file .thumb {
    width: 200<?php //echo $config['thumbWidth'] //kapatılarak sabit ayarlandı ?>px;
    height: 200<?php //echo $config['thumbHeight'] ///kapatılarak sabit ayarlandı ?>px;
    background: no-repeat center center;
        background-size: contain; /* sonrada eklendi. */
}
